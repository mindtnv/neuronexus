...
## Decisions
Prune a copy of the tree with a pure helper, retaining ancestor nodes. Maintain a separate temporary collapsed set while filtering; the saved unfiltered set remains untouched. Reuse TextInput, SegmentedControl and PageSurface.
