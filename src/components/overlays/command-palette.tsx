...
const buildStaticCmdData: StaticBuilder = (t) => {
  ...
  const GRP_GRAPH = t('overlays.palette.groups.graph');
  const GRP_NAV = t('overlays.palette.groups.navigate');
  return [
    { group: GRP_QUICK, id: 'review-now',   icon: 'bolt',    label: t('overlays.palette.quick.reviewNow.label'), sub: t('overlays.palette.quick.reviewNow.sub'), kbd: ['R'], href: '/review' },
    { group: GRP_QUICK, id: 'new-card',     icon: 'plus',    label: t('overlays.palette.quick.newCard.label'),   sub: t('overlays.palette.quick.newCard.sub'),   kbd: ['N'], href: '/editor' },
    { group: GRP_QUICK, id: 'new-deck',     icon: 'stack',   label: t('overlays.palette.quick.newDeck.label'),   sub: null, kbd: [], href: '/decks' },
    { group: GRP_QUICK, id: 'import-pdf',   icon: 'image',   label: t('overlays.palette.quick.importPdf.label'), sub: null, kbd: [], href: '/import' },
    { group: GRP_GRAPH, id: 'node-wohnen',  icon: 'graph',   label: 'wohnen', sub: t('overlays.palette.quick.nodeWohnen.sub'), href: '/graph' },
    { group: GRP_GRAPH, id: 'node-consist', icon: 'graph',   label: t('overlays.palette.quick.nodeConsist.label'), sub: t('overlays.palette.quick.nodeConsist.sub'), href: '/graph' },
    { group: GRP_NAV,   id: 'nav-home',     icon: 'home',    label: t('overlays.palette.quick.goHome'),     sub: null, kbd: ['G', 'H'], href: '/' },
    { group: GRP_NAV,   id: 'nav-review',   icon: 'bolt',    label: t('overlays.palette.quick.goReview'),   sub: null, kbd: ['G', 'R'], href: '/review' },
    { group: GRP_NAV,   id: 'nav-graph',    icon: 'graph',   label: t('overlays.palette.quick.goGraph'),    sub: null, kbd: ['G', 'G'], href: '/graph' },
    { group: GRP_NAV,   id: 'nav-decks',    icon: 'stack',   label: t('overlays.palette.quick.goDecks'),    sub: null, kbd: ['G', 'D'], href: '/decks' },
    { group: GRP_NAV,   id: 'nav-stats',    icon: 'target',  label: t('overlays.palette.quick.goStats'),    sub: null, kbd: ['G', 'S'], href: '/stats' },
    { group: GRP_NAV,   id: 'nav-settings', icon: 'settings',label: t('overlays.palette.quick.goSettings'), sub: null, kbd: ['G', ','], href: '/settings' },
  ];
};
