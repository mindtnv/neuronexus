...
import { NNBadge, NNBtn, NNCard, NNIcon, NNKbd, NNMiniGraph, NNTag } from '@/components/ui';
...
export const NNReviewClassic = () => {
  ...
  if (!bootstrapped) {
    return <ReviewEmpty title={t('states.loading')} subtitle={t('review.loading.subtitle')} />;
  }
